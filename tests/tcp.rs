...
mod tests {
    ...
    pub fn tcp_slow_consumer() {
        // create server, connect client, establish server session
        let server = TcpServer::bind("127.0.0.1:33007").unwrap();
        let mut client = TcpSession::connect("127.0.0.1:33007").unwrap();
    ...
    #[test]
    pub fn tcp_client_server_nonblocking() {
        // create server, connect client, establish server session
    ...
    #[test]
    pub fn tcp_tls_after_establishing_nonblocking() {
        // tls client
        let mut client = TcpSession::connect_nonblocking("www.google.com:443").unwrap();
    ...
    #[test]
    pub fn tcp_tls_before_establishing_nonblocking() {
        // tls client
        let mut client = TcpSession::connect_nonblocking("www.google.com:443")
            .unwrap()
            .into_tls("www.google.com", TLSConfig::default())
            .unwrap();
    ...
    #[test]
    pub fn tcp_slow_consumer_nonblocking() {
        // create server, connect client, establish server session
        let server = TcpServer::bind("127.0.0.1:33002").unwrap();
        let mut client = TcpSession::connect_nonblocking("127.0.0.1:33002").unwrap();
