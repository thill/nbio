...
mod tests {
    ...
    #[test]
    fn one_small_frame_nonblocking() {
        // create server, connect client, establish server session
        let server = TcpServer::bind("127.0.0.1:34006").unwrap();
        let mut client = TcpSession::connect_nonblocking("127.0.0.1:34006").unwrap();
    ...
    #[test]
    fn one_large_frame_nonblocking() {
        // create server, connect client, establish server session
        let server = TcpServer::bind("127.0.0.1:34005").unwrap();
        let mut client = TcpSession::connect_nonblocking("127.0.0.1:34005").unwrap();
    ...
    #[test]
    fn framing_slow_consumer_nonblocking() {
        // create server, connect client, establish server session
        let server = TcpServer::bind("127.0.0.1:34004").unwrap();
        let mut client = TcpSession::connect_nonblocking("127.0.0.1:34004").unwrap();
